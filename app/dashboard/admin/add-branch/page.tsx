    ...
    <div className="max-w-2xl mx-auto p-6">
      ...
      <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6">
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-white/80 text-sm mb-2">Branch Name *</label>
            <input
              type="text"
              value={name}
          ...
          <div>
            <label className="block text-white/80 text-sm mb-2">Location (optional)</label>
            <input
              type="text"
              value={location}
          ...
          {error && (
            <div className="bg-red-500/20 border border-red-400/50 text-red-100 px-4 py-2 rounded-lg">
              {error}
            </div>
          )}

          {success && (
            <div className="bg-green-500/20 border border-green-400/50 text-green-100 px-4 py-2 rounded-lg">
          ...
          <button
            ...
            className="w-full py-3 px-4 rounded-lg bg-white/10 text-white/80 hover:text-white transition-all"
          >
            Cancel
          </button>
        </form>
