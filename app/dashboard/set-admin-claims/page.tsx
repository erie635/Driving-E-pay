...
const CLASS_OPTIONS = ["B1/B2", "B1", "BC1", "C1", "D1", "A1", "A2", "A3"];
        ...
        <div style={styles.container} className="responsive-container">
          ...
          <div className="fee-management-container">
            ...
            <p style={styles.feeNote}>
              * Changes will apply to new students. Existing students' fees remain unchanged.
            </p>
          </div>
          ...
          {/* Form */}
          <form onSubmit={addStudent} style={styles.form} className="responsive-form">
            <input
              type="text"
            ...
            <div style={styles.listContainer}>
              ...
              {students.length === 0 ? (
                ...
                students.map((student) => {
                  ...
                  return (
                    <div key={student.id} style={styles.card} className="responsive-card">
                      <p>
                        <strong>Admission No:</strong>{" "}
                        {student.accountNumber || student.studentAccountId}
                      </p>
                      <p>
                      ...
                      <p>
                        <strong>Class(es):</strong> {classList}
                      </p>
                      <p>
                        <strong>Total Fee:</strong> Ksh {totalFee}
                      </p>
                      <p>
                        <strong>Amount Paid:</strong> Ksh {paid}
                      </p>
                      <p
                        style={{
                          fontWeight: "bold",
